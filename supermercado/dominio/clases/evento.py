...
class Evento:
    ...
    TIPO_ATENCION_CLIENTE = "atencion_cliente"
    TIPO_FIN_ATENCION_CLIENTE = "fin_atencion_cliente"
    TIPO_COMPRA_CLIENTE = "compra_cliente"
    ...
    def __str__(self):
        return "Evento(tipo={tipo}, rnd1={rnd1}, rnd2={rnd2}, tiempo={tiempo}, tiempo_fin={tiempo_fin}, cliente={cliente}, " \
               "caja={caja})".format(
                    tipo=self.tipo,
                    rnd1=str(self.rnd1),
                    rnd2=str(self.rnd2),
